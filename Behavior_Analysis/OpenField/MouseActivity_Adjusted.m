...
%Hi user! This script processes open field videos for analysis! 
%It has been adapted from a freely available open-source code written by the above author^. 
%Despite all the modifications, it is probably still safe to reference him if you use this for
%your own analysis. 

%Press run and follow the instructions to begin.
...
%N.B.:
    ...
    %If you wish to loop through all your videos at once you can use the code OpenField_Automator.m. 
    %However, this has preselected paramaters.
...
% hold off
    ...
    for i=1:mouseN
        ...
        arenaW = arena{i}(:,3);
        arenaH = arena{i}(:,4);
        pixels = 385/arenaW; %pixel size in mm; the arena is 12 x 12 inches. CONVERTED TO 385mm (diameter of arena)
